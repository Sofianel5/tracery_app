...
class SignUpEmailScreen extends StatefulWidget {
  SignUpEmailScreen({this.userRepo, this.json});
    ...
    return Padding(
      ...
      child: GestureDetector(
        onTap: () async {
          ...
          jsonData["email"] = _email.text;
           Navigator.push(context, MaterialPageRoute(builder: (_) => SignUpDobScreen(userRepo: widget.userRepo, json: jsonData)));
          }
        },
